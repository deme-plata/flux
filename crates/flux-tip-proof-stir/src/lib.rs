...
//! │   └────────────────────────────────────────────────────────────┘  │
//! │                                                                  │
//! │   ┌─ anchor_chain (flux_recursive_proofs::LatticeTipProof, 176 B) │  │
//! │   │   v1 BLAKE3-FS hash-chain : anchor → window_start          │  │
//! │   └────────────────────────────────────────────────────────────┘  │
//! │                                                                  │
//! │   ┌─ window_fri_proof (flux_zk_stark::StarkProof, ~2-4 KB) ──────┐  │
...
//!    `flux_zk_stark::StarkSystem`'s real FRI commitment to the trace.
...
/// Byte-for-byte compatible with `flux_zk_types::block::QBlockHeader` under
...
pub struct TipProofStir {
    ...
    pub window_proof: flux_zk_stark::StarkProof,
    ...
    pub anchor_chain: flux_recursive_proofs::LatticeTipProof,
