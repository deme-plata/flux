...
mod tests {
    ...
    // Groth16 trusted setup requires a CryptoRng; ark_std::test_rng() (`impl Rng`) is NOT one.
    // Use a seeded StdRng — deterministic for reproducible tests AND a real CryptoRng.
