...
use flux_lattice_guard::{ArithmeticCircuit, LatticeGuardProof, R1CSConstraint, Scalar};
...
pub struct RecursiveProofConfig {
    ...
    pub security_level: flux_lattice_guard::SecurityLevel,
...
impl Default for RecursiveProofConfig {
    fn default() -> Self {
        Self {
            security_level: flux_lattice_guard::SecurityLevel::PQ128,
