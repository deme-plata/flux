...
fn bench_poseidon_hash(c: &mut Criterion) {
    use flux_recursive_proofs::gadgets::poseidon::{PoseidonGadget, PoseidonParams};
...
fn bench_merkle_verification(c: &mut Criterion) {
    use flux_recursive_proofs::gadgets::merkle::MerkleTreeGadget;
    use flux_recursive_proofs::gadgets::poseidon::PoseidonParams;
    use flux_recursive_proofs::ConstraintBuilder;
...
fn bench_epoch_transition_circuit(c: &mut Criterion) {
    use flux_recursive_proofs::circuits::epoch_transition::{EpochTransitionCircuit, EpochTransitionConfig};
...
fn bench_constraint_estimation(c: &mut Criterion) {
    use flux_recursive_proofs::circuits::epoch_transition::{EpochTransitionCircuit, EpochTransitionConfig};
    use flux_recursive_proofs::circuits::bft_signature::{BFTSignatureCircuit, BFTSignatureConfig};
    use flux_recursive_proofs::circuits::state_transition::{StateTransitionCircuit, StateTransitionConfig};
