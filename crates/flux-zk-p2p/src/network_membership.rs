...
use flux_zk_types::ValidatorId;
use flux_zk_snark::{CircuitBuilder, CircuitGadgets, SNARKConfig, SNARKProtocol, UniversalSNARK};
...
mod tests {
    ...
    fn test_merkle_tree_creation() {
        let validators = vec![
            flux_zk_types::validator_id_from_label("validator1"),
            flux_zk_types::validator_id_from_label("validator2"),
            flux_zk_types::validator_id_from_label("validator3"),
            flux_zk_types::validator_id_from_label("validator4"),
        ];
    ...
    async fn test_membership_proof_generation_and_verification() {
        let validator_id = flux_zk_types::validator_id_from_label("test_validator");
        let validators = vec![
            validator_id.clone(),
            flux_zk_types::validator_id_from_label("other_validator1"),
            flux_zk_types::validator_id_from_label("other_validator2"),
        ];
