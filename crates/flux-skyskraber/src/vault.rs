...
//! breaks at exactly that link. Same construction as a blockchain, minus the
//! consensus — one custodian, tamper-evident forever.
...
impl Vault {
    pub fn new(capacity: usize) -> Self {
        Self { capacity, bars: Vec::new(), audit: Vec::new(), head: [0u8; 32] }
    }
