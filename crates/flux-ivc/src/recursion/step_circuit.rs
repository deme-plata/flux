...
//!       `flux_lattice_guard::LatticeGuardProver` over an arkworks-R1CS →
...
/// `flux_lattice_guard::LatticeGuardProver`. Phase C swaps the per-step
/// prover for a Module-SIS folding accumulator (`flux_lattice_guard::folding`).
///
